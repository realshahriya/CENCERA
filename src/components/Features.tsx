...
export default function Features() {
    return (
        <section id="features" className="py-32 px-6 relative bg-void">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <h3 className="font-mono text-neon text-sm mb-2">// CORE CAPABILITIES</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {/* Feature 1 */}
                    <div className="bg-surface border border-white/10 p-8 hover:border-neon/50 transition-colors group">
                        ...
                        <h3 className="font-sans text-xl font-bold mb-3">Trust Scoring Engine</h3>
                    ...
                    {/* Feature 2 */}
                    <div className="bg-surface border border-white/10 p-8 hover:border-purple-500/50 transition-colors group">
                        ...
                        <h3 className="font-sans text-xl font-bold mb-3">Entity Analysis</h3>
                        <p className="font-mono text-sm text-gray-400 mb-4">
                    ...
                    {/* Feature 3 */}
                    <div className="bg-surface border border-white/10 p-8 hover:border-blue-500/50 transition-colors group">
                        ...
                        <h3 className="font-sans text-xl font-bold mb-3">Transaction Simulator</h3>
                        <p className="font-mono text-sm text-gray-400 mb-4">
                    ...
                    {/* Feature 4 */}
                    <div className="bg-surface border border-white/10 p-8 hover:border-orange-500/50 transition-colors group">
                        ...
                        <h3 className="font-sans text-xl font-bold mb-3">dApp Connection Guard</h3>
                        <p className="font-mono text-sm text-gray-400 mb-4">
                    ...
                    {/* Feature 5 */}
                    <div className="bg-surface border border-white/10 p-8 hover:border-green-500/50 transition-colors group">
                        ...
                        <h3 className="font-sans text-xl font-bold mb-3">API Platform</h3>
                        <p className="font-mono text-sm text-gray-400 mb-4">
                    ...
                    {/* Feature 6 */}
                    <div className="bg-surface border border-white/10 p-8 hover:border-pink-500/50 transition-colors group">
                        ...
                        <h3 className="font-sans text-xl font-bold mb-3">Interactive Sandbox</h3>
                        <p className="font-mono text-sm text-gray-400 mb-4">
