...
import { CheckCircle, Cpu, Keyboard, Graph } from "phosphor-react";
...
function StepShape({
    ...
    const Icon = stepId === "input" ? Keyboard : stepId === "gather" ? Graph : stepId === "engine" ? Cpu : CheckCircle;
    ...
    return (
        ...
        >
            ...
            >
                <Icon className="w-7 h-7 sm:w-8 sm:h-8" weight="duotone" />
            </motion.div>
        </motion.div>
    );
}
