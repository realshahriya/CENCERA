            ...
            <header className="relative min-h-screen flex flex-col justify-center items-center pt-16 sm:pt-20 overflow-hidden px-4">
                ...
                <div className="relative z-10 text-center max-w-5xl">
                    ...
                    <div className="mt-8 sm:mt-12 flex flex-col md:flex-row gap-4 justify-center items-center px-4">
                        <a href="https://apidashboard.cencera.xyz" target="_blank" className="group relative px-6 sm:px-8 py-3 sm:py-4 bg-neon text-black font-mono text-sm sm:text-base font-bold hover:bg-white transition-colors w-full sm:w-auto max-w-xs md:max-w-none flex items-center justify-center gap-2">
