        ...
        <section className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 relative">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
                ...
                <div className="order-2 md:order-1 relative">
                    ...
                    {/* Floating Data Card */}
                    <div className="absolute -bottom-6 -right-4 sm:-bottom-10 sm:-right-10 bg-surface/90 border border-safe/50 p-4 sm:p-6 max-w-[16rem] sm:max-w-xs z-20 backdrop-blur-md shadow-xl">
