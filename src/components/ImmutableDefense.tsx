...
export default function ImmutableDefense() {
    return (
        <section id="core-mechanics" className="py-24 px-6 bg-surface relative overflow-hidden">
            {/* Decoration Code */}
            <div className="absolute top-0 right-0 font-mono text-[10rem] font-bold text-white/5 pointer-events-none select-none -translate-y-1/2 translate-x-1/4">SCORE</div>

            <div className="max-w-7xl mx-auto">
                <div className="mb-16">
                    <h3 className="font-mono text-neon text-sm mb-2">// CAPABILITIES</h3>
                    <h2 className="font-sans text-4xl md:text-6xl font-bold">CORE MECHANICS</h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-full">
                    ...
                    <div className="md:col-span-2 bg-void border border-white/10 p-8 md:p-12 relative overflow-hidden group hover:border-gray-600 transition-colors">
                        <div className="absolute top-0 right-0 p-6">
                            <div className="w-16 h-16 rounded-lg bg-gradient-to-br from-neon/20 to-neon/5 flex items-center justify-center">
                                <BarChart3 className="w-8 h-8 text-neon" strokeWidth={1.5} />
                            </div>
                        </div>
                        <h4 className="font-sans text-2xl font-bold mb-4 z-10 relative">Trust Scoring Engine</h4>
                    ...
                    <div className="md:row-span-2 bg-void border border-white/10 p-8 relative overflow-hidden group neon-border transition-all">
                        ...
                        <h4 className="font-sans text-2xl font-bold mb-8">Entity Analysis</h4>
                    ...
                    <div className="bg-void border border-white/10 p-8 relative overflow-hidden group hover:border-neon/50 transition-colors">
                        ...
                        <h4 className="font-sans text-xl font-bold mb-2">Tx Simulator</h4>
                    ...
                    <div className="bg-void border border-white/10 p-8 relative overflow-hidden group hover:bg-white hover:text-black transition-colors duration-500">
                        ...
                        <h4 className="font-sans text-xl font-bold mb-2">API Platform</h4>
