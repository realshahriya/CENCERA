...
export default function DocsHeader() {
    ...
    return (
        <>
            <nav className="fixed top-0 w-full flex justify-between items-center px-6 sm:px-8 py-4 sm:py-5 z-50 bg-[#111] border-b border-white/10">
                <div className="flex items-center gap-6">
                    <Link href="/" className="flex items-center gap-2 group hidden sm:flex">
                        <ArrowLeft className="w-4 h-4 text-gray-400 group-hover:text-[#92DCE5] transition-colors" />
                    ...
                    <Link href="/docs" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
                        ...
                        <span className="font-display font-bold text-lg sm:text-xl tracking-tighter text-white flex items-center gap-2">
                            CENCERA <span className="text-[#92DCE5] font-mono text-xs mt-1">/DOCS</span>
                        </span>
                    </Link>
                </div>
